...
export default {
  ...
  framework: {
    ...
    template: {
      ...
      pcThemes: [
        {
          id: 'themeVuetify', // 테마 ID
          name: 'themeVuetify', // 테마 이름
          component: () => import('@/layout/layout'), // 테마를 정의하는 레이아웃 Vue 파일
          vuetify: 'themeVuetify',
          echart: 'blue', // echart의 테마 이름 정의
          layoutHideMode: false
        }
      ]
    },
