    ...
    <v-row no-gutters class="matgrid-height">
      <v-col cols="12" sm="12" lg="12" class="pa-2  pb-0" :key="refreshKey">
        <v-carousel height="100%" :show-arrows="false" v-model="carouselIdx">
          <v-carousel-item>
            <v-row no-gutters>
              <v-col cols="12" sm="12" md="12" lg="12" align="center" style="border: thin solid rgba(0, 0, 0, 0.12); background-color: rgb(217,222,238);">
              ...
              <v-col cols="7" class="pa-1 pt-0" style="border: 1px solid; border-radius: 10px;">
                <v-row class="pt-2">
                  ...
                  <v-col cols="12" class="pt-0 pb-0">
                    <span 
                     v-for="(e,idx) in listl.slice(1)" :key="{idx} + 1"
                    class="pa-2" style="font-size: 18px;" >
                ...
                <v-row>
                  <v-col cols="12" class="pa-2 pt-0 pb-0 ">
                    ...
                    >
                      ...
                      <DxColumn data-field="jobNo" caption="작업 지시서 번호" width="15%" data-type="string" alignment="center" format="" css-class="devest-grid-header-require" :allow-editing="false"/>
                      <DxColumn data-field="gubun" caption="작업 지시 구분" width="15%" data-type="string" alignment="center" format="" css-class="devest-grid-header-require" :allow-editing="false"/>
                      <DxColumn data-field="palletId" caption="Pallet ID" width="15%" data-type="string" alignment="center" format="" css-class="devest-grid-header-require" :allow-editing="false"/>
                      <DxColumn data-field="rfidTag" caption="RFID Tag" width="10%" data-type="string" alignment="center" format="" css-class="devest-grid-header-require" :allow-editing="false"/>
                      <DxColumn data-field="rowColLev" caption="RACK 행/열/단" width="10%" data-type="string" alignment="center" format="" css-class="devest-grid-header-require" :allow-editing="false"/>
                      <DxColumn data-field="scCheck" caption="S/C 확인" width="10%" data-type="string" alignment="center" format="" css-class="devest-grid-header-require" :allow-editing="false"/>
                      <DxColumn data-field="remark" caption="비고" width="10%" data-type="string" alignment="center" format="" css-class="devest-grid-header-require" :allow-editing="false"/>
                    </DxDataGrid>
                  </v-col>
                </v-row>
              </v-col>
                  ...
                  <i-card-vertical headerTitle="■ 지게차 작업 리스트">
                    <template v-slot:body>
                      <v-layout column overflow-auto class="pa-2 pt-2">
                          ...
                          >
                            <DxSelection show-check-boxes-mode="false" />
                            <DxColumn data-field="jobNo" caption="작업 지시서 번호" width="12%" data-type="string" alignment="center" css-class="devest-grid-header-require"/>
...
import {
  getPopLineInfoMainList,
  getPopLineInfoMainStorage,
  getPopLineStatus
} from '@/api/kier/pop/lineInfo'
...
export default {
  ...
  data() {
    return {
      ...
      rowColLev: [],
      //자동창고
      aJjt: '', aGbt: '', aRate: '', aH1Jjt: '', aH1gbt: '', aH2Jjt: '', aH2gbt: '',
      //수동창고
      mJjt: '', mGbt: '', mRate: '',
      //S/C작업현황
      jobNo: '', jobDiv: '', palletId: '', rfidTag: '', priority: '', position: '',
      jobStAt: '', jobEdAt: '', compelteYn: '', status: '', statusDesc: '', scColRowLev: '',
      //업데이트 시간
      upTime: '00:00:00',
      listTimer: null,
      stockTimer: null
  ...
  methods: {
    ...
    doSearchMainList(isProgress) {
      return getPopLineInfoMainList({}, isProgress)
        .then(res => {
          let cnt = 1, cnt2 = 1
    ...
    doSearchMainStorage(isProgress) {
      return getPopLineInfoMainStorage({}, isProgress)
        .then(res => {
