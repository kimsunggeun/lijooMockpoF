        ...
        <v-flex xs10 sm8 md6 lg6>
          ...
          <v-card height="460" class="elevation-0">
            ...
            <div class="d-flex flex-column justify-center">
              <svg-icon class="text-h1 mb-4" icon-class="exclamation"></svg-icon>
              ...
              <v-card-subtitle class="sub_title--text text-center mb-4">
                <b
                  >보다 나은 서비스 제공을 위하여 페이지 점검중에 있습니다. <br />
  ...
  methods: {
    ...
    goMain() {
      ...
      this.$router.push(toRouter).catch(error => {
        if (error.name === 'NavigationDuplicated') console.log('NavigationDuplicated')
