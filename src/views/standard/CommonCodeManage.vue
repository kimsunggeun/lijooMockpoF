  ...
  <v-container fluid fill-height align-start ma-0 pa-2>
    <v-row no-gutters>
      ...
      <v-col cols="12" sm="12" lg="6" class="pa-2 pt-0">
        <i-card-vertical headerTitle="공통코드 리스트"
              ...
              <v-col cols="12" md="12" class="pa-0">
                <v-col cols="12" lg="12" class="pa-0">
                  ...
                  >
                    ...
                    <DxColumn data-field="majorCd" caption="공통코드" width="150px" data-type="string" alignment="center" css-class="devest-grid-header-require"/>

                    <DxColumn data-field="majorType" caption="구분" data-type="string" width="100px" alignment="center" css-class="devest-grid-header-require">
      ...
      <v-col cols="12" sm="12" lg="6" class="pa-2 pt-5 pt-lg-0">
        <i-card-vertical headerTitle="상세코드 리스트"
          :useBtnList="buttonUseListMain"
          @btnAdd="btnAddDetail()"
              ...
              <v-col cols="12" md="12" class="row pa-0">
                <v-col cols="12" lg="12" class="pa-0">
                  ...
                  >
                    ...
                    <DxColumn data-field="ordSeq" caption="순번" data-type="number" width="70px" alignment="center" css-class="devest-grid-header-require"/>
...
import {
  ...
  deletelistAll,
  deletelistDetail
} from '@/api/kier/standard/commonCodeManage'
//
...
export default {
  ...
  methods: {
    ...
    doSearchMain(isProgress) {
      ...
      this.gridInit()
      return getListMain(params, isProgress)
        .then(res => {
  ...
  async  btnAddMain() {
    ...
    async btnDeleteMain() {
      ...
      this.vToastifyPrompt(
        ...
        current => {
          this.openLoading()
          this.gridMainInstance.beginUpdate()
          deletelistAll(selectedMainRows.filter(row => !row.isCreated), true)
            .then(res => {
    ...
    async btnDeleteDetail() {
      ...
      this.vToastifyPrompt(
        ...
        current => {
          this.openLoading()
          this.gridDetailInstance.beginUpdate()
          deletelistDetail(selectedDetailRows.filter(row => !row.isCreated), true)
            .then(res => {
    ...
    onFocusedRowChanged(e) {
      ...
      this.openLoading('searching')
      this.doSearchDetail(e.row.data.majorCd)
        .finally(() => {
          this.endLoading()
        })
    },
    ...
    doSearchDetail(majorCd) {
      return getListDetail({majorCd: majorCd}, false)
        .then(res => {
          this.gridDetailInit()
