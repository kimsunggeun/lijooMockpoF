            ...
            <v-layout column overflow-auto>
              <v-col cols="12" md="12" class="pa-0">
                <v-col cols="12" lg="12" class="pa-0">
                  ...
                  >
                    <DxColumn data-field="partnerId" caption="파트너사" width="170px" data-type="string" alignment="left" css-class="devest-grid-header-require">
                    ...
                    <DxColumn data-field="sexDiv" caption="성별" width="100px" data-type="string" alignment="center" css-class="devest-grid-header-require">
                    ...
                    <DxColumn data-field="hpNo" caption="전화번호" width="150px" data-type="string" alignment="center" />
...
export default {
  ...
  methods: {
    ...
    doSearchMain(isProgress) {
      ...
      this.gridInit()
      return getStdPartnerEmployee(params, isProgress)
        .then(res => {
    ...
    async btnDelete() {
      ...
      this.vToastifyPrompt(
        ...
        current => {
          this.openLoading()
          this.gridMainInstance.beginUpdate()
          deleteStdPartnerEmployee(selectedMainRows.filter(row => !row.isCreated), true)
            .then(res => {
              this.doSearchMain(false)
            })
            .finally(() => {
