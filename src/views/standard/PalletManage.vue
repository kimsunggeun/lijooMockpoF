            ...
            <v-layout column>
              <v-row no-gutters class="center pa-2 pb-0">
                ...
                <span style="width: 164px;" class="pa-2 py-md-0">
                  <v-switch v-model="toggleDelYn" true-value="Y" false-value="N" :label="`삭제 데이터 조회`" @click="btnSearch()" />
                </span>
              </v-row>
            </v-layout>
          </template>
                ...
                <v-col cols="12" lg="12" class="pa-0">
                  ...
                  >
                    ...
                    <DxColumn
                      ...
                      css-class="devest-grid-header-require"
                    >
                      <DxLookup :data-source="rfidTagList" value-expr="desc" display-expr="desc" />
                    </DxColumn>
...
import { getStdPalletManage, saveStdPalletManage, deleteStdPalletManage, printStdPalletManage } from '@/api/kier/standard/palletManage'
...
export default {
  ...
  methods: {
    ...
    doSearchMain(isProgress) {
      ...
      this.gridInit()
      return getStdPalletManage(params, isProgress).then(res => {
