              ...
              <v-col cols="12" md="12" class="pa-0">
                <v-col cols="12" lg="12" class="pa-0">
                  ...
                  >
                    ...
                    <DxColumn data-field="hpNo" caption="창고 담당자 전화번호" width="150px" data-type="string" alignment="center" :allow-editing="false"/>
                    ...
                    <template #checkBoxEditor="{ data: cellInfo }">
                      <DxCheckBox 
                        ...
                        :read-only="cellInfo.data.status != 'STS01' || cellInfo.data.orgCompleteYn == 'Y' || delYn == 'N' && cellInfo.column.dataField == 'delYn'"
                      />
                    </template>
...
export default {
  ...
  methods: {
    ...
    doSearchMain(isProgress) {
      ...
      this.gridInit()
      return getScmOrderManageMain(params, isProgress)
        .then(res => {
    ...
    doSearchDetail(poNo) {
      ...
      return getScmOrderManageDetail(params, false)
        .then(res => {
          this.gridDetailInit()
